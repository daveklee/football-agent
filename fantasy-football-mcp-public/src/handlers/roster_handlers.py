...
async def handle_ff_get_roster(arguments: dict) -> dict:
    ...
    # This ensures backward compatibility when users pass include_projections=True
    if include_projections_explicit and not include_projections:
        effective_projections = False
    elif include_projections_explicit and include_projections:
        effective_projections = True
        
    if include_external_explicit and not include_external_data:
        effective_external = False
    elif include_external_explicit and include_external_data:
        effective_external = True
        
    if include_analysis_explicit and not include_analysis:
        effective_analysis = False
    elif include_analysis_explicit and include_analysis:
        effective_analysis = True
