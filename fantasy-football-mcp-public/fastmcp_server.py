...
_TOOL_PROMPTS: Dict[str, str] = {
    ...
    # REMOVED: ff_build_lineup - Agent should use LLM reasoning instead of relying on MCP server lineup suggestions
    # "ff_build_lineup": (
...
# REMOVED: ff_build_lineup tool - Agent should use LLM reasoning instead
# The agent should analyze roster data, league rules, and matchups using its own reasoning
# rather than relying on potentially incorrect lineup suggestions from the MCP server.
# @server.tool(
...
__all__ = [
    ...
    "ff_get_players",
    "ff_compare_teams",
    # "ff_build_lineup",  # REMOVED - Agent uses LLM reasoning instead
    "ff_refresh_token",
    "ff_get_api_status",
    "ff_clear_cache",
    "ff_get_draft_results",
